...
| D124 | A small map on the entity and device pages | A card "On the map" with a still MapLibre map: the newest position marked and the last ten positions as a thin trail, fitted to the trail, no gestures, the whole map a link to the live map on the object. | Someone reading an entity or device page wants to see where it is without opening the live map; a still preview keeps the page scrolling on a phone and stays light. Decided by Tim on 2026-09-07. |
