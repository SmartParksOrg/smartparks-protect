...
- Verified: frontend lint, types, catalogue, 29 tests and the build; ruff and mypy on the API. The map API test with the `assigned_since` assertion could not run here (Docker Desktop was off); CI runs it. Not committed.
