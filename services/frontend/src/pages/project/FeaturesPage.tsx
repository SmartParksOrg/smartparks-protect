...
export function FeaturesPage() {
  ...
  return (
    <>
      ...
      <Page><DataTable columns={columns} data={features.data?.items} searchable isLoading={features.isPending} emptyMessage={t("No features yet. Draw a site, zone, geofence or route with New feature.")} /></Page>
