...
export function MembersPage() {
  ...
  const changeMember = useMutationToast({
    ...
    invalidate: [queryKeys.members(projectId), queryKeys.roles(projectId)],
