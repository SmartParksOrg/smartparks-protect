...
export interface paths {
  ...
  "/api/v1/devices/{device_id}/connectivity": {
    ...
    /**
     * Device Connectivity
     * @description How every network the device is reachable through performs (architecture 20, decision
     ...
     */
    get: operations["device_connectivity_api_v1_devices__device_id__connectivity_get"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  "/api/v1/projects/{project_id}/map/network-locations": {
    ...
    /**
     * Network Locations
     * @description Where the networks placed the scope's devices (decisions D162 and D163): the positions
     ...
     */
    get: operations["network_locations_api_v1_projects__project_id__map_network_locations_get"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
...
export interface components {
  schemas: {
     ...
     */
    Aggregate:
      "mean" | "min" | "max" | "median" | "sum" | "count" | "first" | "last";
    /** AiActionInfo */
    AiActionInfo: {
      /** Action */
      action: string;
     ...
     */
    EntityGroup:
      "tracked" | "infrastructure" | "environmental" | "equipment" | "site";
    /**
     * EntityGroupCreate
    ...
    IridiumLink: {
      /**
       * Last Session
       * @description The last satellite session as the ingest normalised it
       */
      last_session?: {
        [key: string]: unknown;
      } | null;
      /**
       * Sessions
       * @description Sessions in the period, redeliveries left out
       */
      sessions: number;
      /**
       * Bytes
       * @description Bytes carried in the period
       */
      bytes: number;
      /**
       * Missed
       * @description Sessions the counter skipped in the period
       */
      missed: number;
      /**
       * Duplicates
       * @description Redeliveries in the period
       */
      duplicates: number;
    };
    /** JobCreate */
    ...
    LoRaWANLink: {
      /**
       * Uplinks
       * @description Uplinks with a reception in the period
       */
      uplinks: number;
      /** Receptions */
      receptions: number;
      ...
      /**
       * Missed Frames
       * @description Gaps in the uplink frame counter over the period
       * @default 0
       */
      missed_frames: number;
      /**
       * Frames Seen
       * @description Uplinks with a frame counter in the period
       * @default 0
       */
      frames_seen: number;
      /** Gateways */
    ...
    NetworkLocationsResponse: {
      ...
      /**
       * Total
       * @description Network locations in the window and view
       */
      total: number;
      /**
       * Capped
       * @description True when more exist than were returned
       */
      capped: boolean;
      /** Features */
      features: {
    ...
    SourceConnectivity: {
      ...
      /**
       * Channel
       * @description lorawan, iridium, webble, log_file, api or cellular
       */
      channel: string;
      /**
       * Status
       * @description online, silent or unknown
       */
      status: string;
      /** Last Contact At */
      ...
      lorawan?: components["schemas"]["LoRaWANLink"] | null;
      iridium?: components["schemas"]["IridiumLink"] | null;
    };
    /** SourceEventRead */
    SourceEventRead: {
      /** Id */
...
export interface operations {
  ...
  change_entity_assignment_api_v1_projects__project_id__entity_assignments__assignment_id__patch: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["AssignmentChange"]
          | components["schemas"]["AssignmentEnd"];
      };
    };
    responses: {
      /** @description Successful Response */
  ...
  device_connectivity_api_v1_devices__device_id__connectivity_get: {
    parameters: {
      query?: {
        hours?: number;
      };
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["DeviceConnectivityRead"];
        };
      };
      /** @description Validation Error */
      422: {
  ...
  network_locations_api_v1_projects__project_id__map_network_locations_get: {
    parameters: {
      query?: {
        /** @description west,south,east,north in WGS84 */
        bbox?: string | null;
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["NetworkLocationsResponse"];
        };
      };
      /** @description Validation Error */
      422: {
