...
export const devicePerformanceLabels = (
  ...
  firmware: t("Firmware"),
  expected_fix_s: t("Fix interval expected (s)"),
  expected_fix_source: t("Expected interval from"),
  fix_regular_share: t("Regular fixes"),
...
export const movementLabels = (t: Translate): Record<string, string> => ({
  ...
  akde50_ha: t("Corrected KDE 50% (ha)"),
  akde95_ha: t("Corrected KDE 95% (ha)"),
  akde_bandwidth_m: t("Corrected KDE bandwidth (m)"),
  autocorrelation_h: t("Autocorrelation time (h)"),
  effective_fixes: t("Effective fixes"),
  strategy: t("Strategy"),
  strategy_margin: t("Strategy margin (AICc)"),
  strategy_distance_km: t("Strategy distance (km)"),
  departure_day: t("Departure (day of period)"),
  return_day: t("Return (day of period)"),
  strategy_resident: t("Resident"),
  strategy_migratory: t("Migratory"),
  strategy_dispersal: t("Dispersal"),
  strategy_nomadic: t("Nomadic"),
  strategy_unclear: t("Unclear"),
...
export const grazingLabels = (t: Translate): Record<string, string> => ({
  ...
  vegetation: t("Use against vegetation"),
  ndvi_mean: t("Vegetation index (NDVI)"),
  ndvi_change: t("Vegetation change"),
  ndvi_valid_share: t("Weeks with a clear view"),
  ndvi_level: t("Level"),
  ndvi_weekly: t("Vegetation index by week"),
