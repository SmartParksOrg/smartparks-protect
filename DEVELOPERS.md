...
`shared/exports/cleanup.py` (`expire_exports`) is the retention sweep the export service runs hourly through `Worker.background`; migration 0014 adds the `expired` status.
